...
import { WaveLines, FloatingParticles, FlowDiagram, TradeNetwork, ImprovedBuyerJourneyGraphic, ImprovedSellerJourneyGraphic, ImprovedCostLeaksGraphic, ImprovedCostComparisonGraphic, ImprovedPlatformHubGraphic } from './graphics';
...
const sellerCoordinates = [
  ...
  { action: 'Inspection + shipment coordination', icon: Icons.plane }
];
        ...
        <div className="winwin-content">
            ...
            >
              ...
              <div className="winwin-solution-intro">
                ...
                <ul className="winwin-benefits-list">
                  <li>Organizes trade into visible milestones</li>
                  <li>Helps reduce avoidable mistakes (documents, coordination)</li>
                  <li>Supports inspection-backed clarity</li>
                  <li>Helps coordinate shipping options with clearer breakdowns</li>
                </ul>
          ...
          {activeTab === 'seller' && (
            ...
            >
              ...
              <div className="winwin-solution-intro">
                <h4>How Aaziko helps:</h4>
                <ul className="winwin-benefits-list">
                  <li>Gives sellers a system to present clear capability + product info</li>
                  <li>Supports a structured trade journey (less back-and-forth)</li>
                  <li>Helps sellers win buyer trust through process + proof</li>
                </ul>
              </div>
          ...
          {activeTab === 'cost' && (
            ...
            >
              ...
              {/* Visual Cost Leaks Graphic */}
              <div className="winwin-graphic-container" style={{ marginBottom: '24px', padding: '16px', background: 'linear-gradient(135deg, rgba(220, 38, 38, 0.03) 0%, rgba(245, 158, 11, 0.02) 100%)', borderRadius: '16px', border: '1px solid rgba(220, 38, 38, 0.1)' }}>
                <ImprovedCostLeaksGraphic isActive={activeTab === 'cost'} />
              </div>
