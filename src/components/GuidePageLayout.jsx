// Guide Page Layout Component - Reusable SEO-friendly structure for guide pages
...
/**
 * GuidePageLayout - Reusable layout for SEO guide pages
 * 
 * Props:
 * - title (string): H1 page title
 * - intro (string | ReactNode): Introduction paragraph (6-10 lines)
 ...
 * - badge (string): Optional badge text above title (defaults to "Trade Guide")
      ...
      <main className="seo-main">
        ...
        {relatedLinks.length > 0 && (
          <section className="seo-section seo-related-section">
            <div className="seo-container">
              <h2 className="seo-section-title">Related Guides & Resources</h2>
