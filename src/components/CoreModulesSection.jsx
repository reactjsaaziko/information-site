...
import { GeometricShapes, GlowOrbs, FlowDiagram, TradeNetwork, ImprovedMarketplaceGraphic, ImprovedLSQGraphic, ImprovedMessageCenterGraphic, ImprovedLogisticsGraphic, ImprovedCustomsGraphic, ImprovedInspectionGraphic, ImprovedFinancingGraphic, ImprovedInsuranceGraphic, ImprovedTradeJourneyGraphic } from './graphics';
...
export default function CoreModulesSection() {
  ...
  return (
    <div
      ref={sectionRef}
      className="core-modules-section"
    >
      {/* Background Effects */}
          ...
          {modules.map((module, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Visual Graphic */}
                <div className="core-module-graphic" style={{ 
